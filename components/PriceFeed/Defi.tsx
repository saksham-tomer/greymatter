...
function Defi() {
  ...
  const [currentComponent, setCurrentComponent] = React.useState<Component>("Stake");
  ...
  const renderActiveComponent = () => {
    switch (active) {
      ...
      case Active.Stake:
        return (
          <div className="max-w-8xl flex  justify-center font-cygnito">
          <StakeComponent />
          </div>
        );
  ...
  return (
    <div className='flex flex-col min-h-screen w-full bg-gradient-to-br from-gray-800 to-gray-950 px-4 sm:px-6 md:px-12 lg:px-20 xl:px-32'>
